...
<body>
    <header>
        <div class="container">
            <img src="C:\Users\Lenovo\Downloads\logo.png" width="70%" align="center">
            <nav>
                <ul>
...
<body>
    <header>
        <div class="container">
            <img src="C:\Users\Lenovo\Downloads\logo.png" width="50%" alt="College Logo">
            <nav>
                <ul>
                    <li><a href="index.html">Home</a></li>
                    <li><a href="academics.html">Academics</a></li>
...
<body>
    <header>
        <div class="container">
            <img src="C:\Users\Lenovo\Downloads\logo.png"  width="70%" alt="College Logo">
            <center>
            <h1 font-size="70">Saveetha Engineering College</h1>
            </center>
            <nav>
                <ul>
                    <li><a href="index.html">Home</a></li>
...
## output 
![alt text](<Screenshot 2024-07-02 144758.png>)
![alt text](<Screenshot 2024-07-02 144810.png>)
![alt text](<Screenshot 2024-07-02 144820.png>)
![alt text](<Screenshot 2024-07-02 144933.png>)